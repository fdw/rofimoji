...
class WMenu(Selector):
    ...
    def show_character_selection(
        ...
        return DEFAULT(), [self._extract_char_from_output(line) for line in wmenu.stdout.splitlines()]
    ...
    def show_skin_tone_selection(
        ...
        return wmenu.returncode, self._extract_char_from_output(wmenu.stdout)
